...
const NavBar = () => {
  ...
  return (
    <div className={`flex w-full z-10 mx-auto ss:pt-2 lg:pt-6 lg:pb-4 py-2 lg:pl-16 me:pl-8 pl-4 fixed ${(Offset !== 0)&&'bg-background'}`}>
      <img src={logo} className="xl:w-28 lg:w-24 w-16 md:w-24 ss:w-20 2xl:w-28"/>
